...
/**
 * Example code that demonstrates Difference Array, this code is not mine an can be found alongside an explanation in:
 * <p>
...
class GFG {
    ...
    public static void main(String[] args) {
        ...
        // setRangeChanges(l, r, x) updates D[r+1]
        int D[] = new int[n + 1];
        initializeDiffArray(A, D);

        // After below setRangeChanges(l, r, x), the
